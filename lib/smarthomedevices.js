                    ...
                    for (let param of prop.parameters) {
                        if (param.name === 'colorName' && param.constraint && param.constraint.options) {
                            ...
                            for (let i = 0; i < param.constraint.options.length; i++) {
                                displayValues[i] = param.constraint.options[i].displayName;
                            ...
                            console.log('Patched setColor: ' + JSON.stringify(capabilityObjects['Alexa.ColorController'].color[0]));
                        }
                    }
                }
                break;
                ...
                if (prop.parameters) {
                    for (let param of prop.parameters) {
                        if (param.name === 'colorTemperatureName' && param.constraint && param.constraint.options) {
                            ...
                            console.log('Patched setColorTemperature: ' + JSON.stringify(capabilityObjects['Alexa.ColorTemperatureController'].colorTemperatureInKelvin[0]));
                        }
                    }
                }
                break;
