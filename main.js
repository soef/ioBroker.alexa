...
const knownDeviceType = {
    ...
    'A32DOYMUN6DTXA':   {name: 'Echo Dot 3.Gen', commandSupport: true, icon: '/icons/echo_dot.png'}, // AUDIO_PLAYER,POPTART,TUNE_IN,PAIR_BT_SINK,TIMERS_AND_ALARMS,MICROPHONE,SUPPORTS_SOFTWARE_VERSION,ASCENDING_ALARM_VOLUME,CHANGE_NAME,CUSTOM_ALARM_TONE,SET_LOCALE,GADGETS,VOICE_TRAINING,PAIR_REMOTE,SLEEP,SOUND_SETTINGS,TAHOE_BYOD,DEREGISTER_DEVICE,REMINDERS,GOLDFISH,VOLUME_SETTING,FAR_FIELD_WAKE_WORD,LEMUR_ALPHA,REQUIRES_OOBE_FOR_SETUP,TUPLE,PANDORA,PAIR_BT_SOURCE,ACTIVE_AFTER_FRO,SALMON,TUPLE_CATEGORY_A,SUPPORTS_CONNECTED_HOME_CLOUD_ONLY,AMAZON_MUSIC,PERSISTENT_CONNECTION,FLASH_BRIEFING,DREAM_TRAINING,ALLOW_LOG_UPLOAD,I_HEART_RADIO,AUDIBLE,UPDATE_WIFI,EARCONS,KINDLE_BOOKS
